    ...
    return (
        <div id="how-does">
            <section className="how-does">
                <div>
                    <h2><img src="../img/howdoes.png" alt="How Does Task Elephant" /> How Does Task Elephant Do It?</h2>
                    <p>
                    ...
                    <div>
                        <Stack direction="row" spacing={2}>
                            <ItemLeft className="animate">Recording income and expenses</ItemLeft>
                            <ItemLeft className="animate">Categorizing transactions</ItemLeft>
                            <ItemRight className="animate">Reconciling bank statements</ItemRight>
