  ...
  return (
    <>
      ...
      <section className="what-we-do">
        <div>
          <h2><img src="../img/whatwedo.png" /> What Does Task Elephant Do?</h2>
          <p>
            ...
            of turnover or rate increases.
            </p><p> Using our client ‘on-boarding
     ...
     <HowDoes/>
      ...
      <section className="why-us">
        <div>
          <h2><img src="../img/whyus.png" className="why-do-us-img"/> Why Task Elephant?</h2>
          <p>
            <b>
